...
<br>Since the kext is under development, the internet speed in 5GHz is little bit slow. On the other hand <b>Bluetooth</b> inside the Intel card works perfectly fine. To enable Intel 9560 watch the video: <a href="https://www.youtube.com/watch?v=j6Fa5r1Ufi0" target="_blank">Video</a> and download the latest release from: <a href="https://github.com/1hbb/OpenIntelWireless-Factory/releases/tag/2020-07-26" target="_blank">here</a>.
</p>
