...
<p align="justify" > 
  ...
  <br>&nbsp;⑥ After making a USB bootable device, download "Clover Configurator" inside the VirtualBox. Mount the EFI &emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;partition, of the USB drive, using clover configurator, and replace the EFI folder with my EFI folder (unzip EFI.7z &emsp;&emsp;&emsp;&nbsp;&nbsp;before placing it inside EFI partition).
